package com.ravlal.ravlaliosswitchview;
...
/**
 * Created by Raviteja Emandi on 09,June,2023
 **/
public class RavlaliOSSwitchView extends View {
        ...
        public RavlaliOSSwitchView(Context context) {
            this(context, null);
        }

        public RavlaliOSSwitchView(Context context, AttributeSet attrs) {
            super(context, attrs);
            init(attrs);
        ...
        public interface OnCheckedChangeListener {
            void onCheckedChanged(RavlaliOSSwitchView switchView, boolean isChecked);
        }
